...
window.onload=function()
{
	...
	function typing()
	{
		if (i <= str.length)
		{
		...
		}else
		 {
			...
			setTimeout(function(){$("#content").animate({height:'100%'},800)},300);
		}
	}
	typing();
	...
	$("#cleft_li01").click(function(){
		$("#cleft_li01").css({"background-color":"#ffffff"});
		$("#cleft_li02").css({"background-color":"#f6f7ff"});
		$("#cleft_li03").css({"background-color":"#f6f7ff"});
		$("#cleft_li04").css({"background-color":"#f6f7ff"});
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
		$("#cleft_li08").css({"background-color":"#f6f7ff"});
	...
	$("#cleft_li02").click(function(){
		$("#cleft_li01").css({"background-color":"#f6f7ff"});
		$("#cleft_li02").css({"background-color":"#ffffff"});
		$("#cleft_li03").css({"background-color":"#f6f7ff"});
		$("#cleft_li04").css({"background-color":"#f6f7ff"});
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
	...
	$("#cleft_li03").click(function(){
		$("#cleft_li01").css({"background-color":"#f6f7ff"});
		$("#cleft_li02").css({"background-color":"#f6f7ff"});
		$("#cleft_li03").css({"background-color":"#ffffff"});
		$("#cleft_li04").css({"background-color":"#f6f7ff"});
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
		$("#cleft_li08").css({"background-color":"#f6f7ff"});
	...
	$("#cleft_li04").click(function(){
		...
		$("#cleft_li02").css({"background-color":"#f6f7ff"});
		$("#cleft_li03").css({"background-color":"#f6f7ff"});
		$("#cleft_li04").css({"background-color":"#ffffff"});
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
		$("#cleft_li08").css({"background-color":"#f6f7ff"});
		$("#nav01").animate({"left":"-100%"},800);
	...
	$("#cleft_li05").click(function(){
		...
		$("#cleft_li03").css({"background-color":"#f6f7ff"});
		$("#cleft_li04").css({"background-color":"#f6f7ff"});
		$("#cleft_li05").css({"background-color":"#ffffff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
		$("#cleft_li08").css({"background-color":"#f6f7ff"});
		$("#nav01").animate({"left":"-100%"},800);
		$("#nav02").animate({"left":"-100%"},800);
	...
	$("#cleft_li07").click(function(){
		...
		$("#cleft_li04").css({"background-color":"#f6f7ff"});
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#ffffff"});
		$("#cleft_li08").css({"background-color":"#f6f7ff"});
		$("#nav01").animate({"left":"-100%"},800);
		$("#nav02").animate({"left":"-100%"},800);
		$("#nav03").animate({"left":"-100%"},800);
	...
	$("#cleft_li08").click(function(){
		...
		$("#cleft_li05").css({"background-color":"#f6f7ff"});
		$("#cleft_li07").css({"background-color":"#f6f7ff"});
		$("#cleft_li08").css({"background-color":"#ffffff"});
		$("#nav01").animate({"left":"-100%"},800);
		$("#nav02").animate({"left":"-100%"},800);
		$("#nav03").animate({"left":"-100%"},800);
		$("#nav04").animate({"left":"-100%"},800);
